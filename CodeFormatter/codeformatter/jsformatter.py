...
class JsFormatter:
	...
	def format(self, text):
		...
		if (opts["space_before_conditional"]):
			options.append("space_before_conditional:true")
		else:
			options.append("space_before_conditional:false")

		if (opts["keep_function_indentation"]):
			options.append("keep_function_indentation:true")
		else:
			options.append("keep_function_indentation:false")
